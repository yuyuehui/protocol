...
const file_conversation_conversation_proto_rawDesc = "" +
	"\n" +
	"\x1fconversation/conversation.proto\x12\x13openim.conversation\x1a\x11sdkws/sdkws.proto\x1a\x1bwrapperspb/wrapperspb.proto\"\xb8\x05\n" +
	"\fConversation\x12 \n" +
	...
	"\x15updateUnreadCountTime\x18\x14 \x01(\x03R\x15updateUnreadCountTime\"\xf7\a\n" +
	...
	"\x15updateUnreadCountTime\x18\x12 \x01(\v2\x1b.openim.protobuf.Int64ValueR\x15updateUnreadCountTime\"[\n" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\xfa\x06\n" +
	...
	"\x06isMark\x18\x0f \x01(\v2\x1a.openim.protobuf.BoolValueR\x06isMark\"\x18\n" +
	...
	"\x17DeleteConversationsResp\"\x97\x02\n" +
	...
	"\x0fconversationIDs\x18\x01 \x03(\tR\x0fconversationIDs2\xc4'\n" +
	"\fconversation\x12d\n" +
	...
	"\x13DeleteConversations\x12+.openim.conversation.DeleteConversationsReq\x1a,.openim.conversation.DeleteConversationsResp\x12y\n" +
	...
	"\x1bGetConversationIDsByGroupID\x123.openim.conversation.GetConversationIDsByGroupIDReq\x1a4.openim.conversation.GetConversationIDsByGroupIDRespB,Z*github.com/openimsdk/protocol/conversationb\x06proto3"
...
var file_conversation_conversation_proto_msgTypes = make([]protoimpl.MessageInfo, 84)
var file_conversation_conversation_proto_goTypes = []any{
	...
	(*ConversationGroup)(nil),                           // 60: openim.conversation.ConversationGroup
	(*GroupOrder)(nil),                                  // 61: openim.conversation.GroupOrder
	(*InitConversationGroupsReq)(nil),                   // 62: openim.conversation.InitConversationGroupsReq
	(*InitConversationGroupsResp)(nil),                  // 63: openim.conversation.InitConversationGroupsResp
	(*GetAllConversationGroupsReq)(nil),                 // 64: openim.conversation.GetAllConversationGroupsReq
	(*GetAllConversationGroupsResp)(nil),                // 65: openim.conversation.GetAllConversationGroupsResp
	(*GetVisibleConversationGroupsReq)(nil),             // 66: openim.conversation.GetVisibleConversationGroupsReq
	(*GetVisibleConversationGroupsResp)(nil),            // 67: openim.conversation.GetVisibleConversationGroupsResp
	(*CreateConversationGroupReq)(nil),                  // 68: openim.conversation.CreateConversationGroupReq
	(*CreateConversationGroupResp)(nil),                 // 69: openim.conversation.CreateConversationGroupResp
	(*UpdateConversationGroupReq)(nil),                  // 70: openim.conversation.UpdateConversationGroupReq
	(*UpdateConversationGroupResp)(nil),                 // 71: openim.conversation.UpdateConversationGroupResp
	(*DeleteConversationGroupReq)(nil),                  // 72: openim.conversation.DeleteConversationGroupReq
	(*DeleteConversationGroupResp)(nil),                 // 73: openim.conversation.DeleteConversationGroupResp
	(*UpdateConversationGroupSortReq)(nil),              // 74: openim.conversation.UpdateConversationGroupSortReq
	(*UpdateConversationGroupSortResp)(nil),             // 75: openim.conversation.UpdateConversationGroupSortResp
	(*SetConversationGroupVisibilityReq)(nil),           // 76: openim.conversation.SetConversationGroupVisibilityReq
	(*SetConversationGroupVisibilityResp)(nil),          // 77: openim.conversation.SetConversationGroupVisibilityResp
	(*AddConversationsToGroupReq)(nil),                  // 78: openim.conversation.AddConversationsToGroupReq
	(*AddConversationsToGroupResp)(nil),                 // 79: openim.conversation.AddConversationsToGroupResp
	(*RemoveConversationsFromGroupReq)(nil),             // 80: openim.conversation.RemoveConversationsFromGroupReq
	(*RemoveConversationsFromGroupResp)(nil),            // 81: openim.conversation.RemoveConversationsFromGroupResp
	(*GetConversationIDsByGroupIDReq)(nil),              // 82: openim.conversation.GetConversationIDsByGroupIDReq
	(*GetConversationIDsByGroupIDResp)(nil),             // 83: openim.conversation.GetConversationIDsByGroupIDResp
	(*wrapperspb.Int32Value)(nil),                       // 84: openim.protobuf.Int32Value
	(*wrapperspb.BoolValue)(nil),                        // 85: openim.protobuf.BoolValue
	(*wrapperspb.StringValue)(nil),                      // 86: openim.protobuf.StringValue
	(*wrapperspb.Int64Value)(nil),                       // 87: openim.protobuf.Int64Value
	(*sdkws.RequestPagination)(nil),                     // 88: openim.sdkws.RequestPagination
}
var file_conversation_conversation_proto_depIdxs = []int32{
	84, // 0: openim.conversation.ConversationReq.recvMsgOpt:type_name -> openim.protobuf.Int32Value
	85, // 1: openim.conversation.ConversationReq.isPinned:type_name -> openim.protobuf.BoolValue
	86, // 2: openim.conversation.ConversationReq.attachedInfo:type_name -> openim.protobuf.StringValue
	85, // 3: openim.conversation.ConversationReq.isPrivateChat:type_name -> openim.protobuf.BoolValue
	86, // 4: openim.conversation.ConversationReq.ex:type_name -> openim.protobuf.StringValue
	84, // 5: openim.conversation.ConversationReq.burnDuration:type_name -> openim.protobuf.Int32Value
	87, // 6: openim.conversation.ConversationReq.minSeq:type_name -> openim.protobuf.Int64Value
	87, // 7: openim.conversation.ConversationReq.maxSeq:type_name -> openim.protobuf.Int64Value
	84, // 8: openim.conversation.ConversationReq.groupAtType:type_name -> openim.protobuf.Int32Value
	87, // 9: openim.conversation.ConversationReq.msgDestructTime:type_name -> openim.protobuf.Int64Value
	85, // 10: openim.conversation.ConversationReq.isMsgDestruct:type_name -> openim.protobuf.BoolValue
	85, // 11: openim.conversation.ConversationReq.isMark:type_name -> openim.protobuf.BoolValue
	84, // 12: openim.conversation.ConversationReq.unreadCount:type_name -> openim.protobuf.Int32Value
	87, // 13: openim.conversation.ConversationReq.updateUnreadCountTime:type_name -> openim.protobuf.Int64Value
	0,  // 14: openim.conversation.SetConversationReq.conversation:type_name -> openim.conversation.Conversation
	0,  // 15: openim.conversation.GetConversationResp.conversation:type_name -> openim.conversation.Conversation
	88, // 16: openim.conversation.GetSortedConversationListReq.pagination:type_name -> openim.sdkws.RequestPagination
	8,  // 17: openim.conversation.GetSortedConversationListResp.conversationElems:type_name -> openim.conversation.ConversationElem
	9,  // 18: openim.conversation.ConversationElem.msgInfo:type_name -> openim.conversation.MsgInfo
	0,  // 19: openim.conversation.GetConversationsResp.conversations:type_name -> openim.conversation.Conversation
	0,  // 20: openim.conversation.GetAllConversationsResp.conversations:type_name -> openim.conversation.Conversation
	1,  // 21: openim.conversation.SetConversationsReq.conversation:type_name -> openim.conversation.ConversationReq
	0,  // 22: openim.conversation.GetConversationsByConversationIDResp.conversations:type_name -> openim.conversation.Conversation
	84, // 23: openim.conversation.UpdateConversationReq.recvMsgOpt:type_name -> openim.protobuf.Int32Value
	85, // 24: openim.conversation.UpdateConversationReq.isPinned:type_name -> openim.protobuf.BoolValue
	86, // 25: openim.conversation.UpdateConversationReq.attachedInfo:type_name -> openim.protobuf.StringValue
	85, // 26: openim.conversation.UpdateConversationReq.isPrivateChat:type_name -> openim.protobuf.BoolValue
	86, // 27: openim.conversation.UpdateConversationReq.ex:type_name -> openim.protobuf.StringValue
	84, // 28: openim.conversation.UpdateConversationReq.burnDuration:type_name -> openim.protobuf.Int32Value
	87, // 29: openim.conversation.UpdateConversationReq.minSeq:type_name -> openim.protobuf.Int64Value
	87, // 30: openim.conversation.UpdateConversationReq.maxSeq:type_name -> openim.protobuf.Int64Value
	84, // 31: openim.conversation.UpdateConversationReq.groupAtType:type_name -> openim.protobuf.Int32Value
	87, // 32: openim.conversation.UpdateConversationReq.msgDestructTime:type_name -> openim.protobuf.Int64Value
	85, // 33: openim.conversation.UpdateConversationReq.isMsgDestruct:type_name -> openim.protobuf.BoolValue
	87, // 34: openim.conversation.UpdateConversationReq.latestMsgDestructTime:type_name -> openim.protobuf.Int64Value
	85, // 35: openim.conversation.UpdateConversationReq.isMark:type_name -> openim.protobuf.BoolValue
	...
	88, // 38: openim.conversation.GetOwnerConversationReq.pagination:type_name -> openim.sdkws.RequestPagination
	...
	86, // 41: openim.conversation.UpdateConversationsByUserReq.ex:type_name -> openim.protobuf.StringValue
	60, // 42: openim.conversation.GetAllConversationGroupsResp.groups:type_name -> openim.conversation.ConversationGroup
	60, // 43: openim.conversation.GetVisibleConversationGroupsResp.groups:type_name -> openim.conversation.ConversationGroup
	60, // 44: openim.conversation.CreateConversationGroupResp.group:type_name -> openim.conversation.ConversationGroup
	61, // 45: openim.conversation.UpdateConversationGroupSortReq.groupOrders:type_name -> openim.conversation.GroupOrder
	4,  // 46: openim.conversation.conversation.GetConversation:input_type -> openim.conversation.GetConversationReq
	6,  // 47: openim.conversation.conversation.GetSortedConversationList:input_type -> openim.conversation.GetSortedConversationListReq
	12, // 48: openim.conversation.conversation.GetAllConversations:input_type -> openim.conversation.GetAllConversationsReq
	10, // 49: openim.conversation.conversation.GetConversations:input_type -> openim.conversation.GetConversationsReq
	2,  // 50: openim.conversation.conversation.SetConversation:input_type -> openim.conversation.SetConversationReq
	14, // 51: openim.conversation.conversation.GetRecvMsgNotNotifyUserIDs:input_type -> openim.conversation.GetRecvMsgNotNotifyUserIDsReq
	16, // 52: openim.conversation.conversation.CreateSingleChatConversations:input_type -> openim.conversation.CreateSingleChatConversationsReq
	18, // 53: openim.conversation.conversation.CreateGroupChatConversations:input_type -> openim.conversation.CreateGroupChatConversationsReq
	20, // 54: openim.conversation.conversation.SetConversationMaxSeq:input_type -> openim.conversation.SetConversationMaxSeqReq
	22, // 55: openim.conversation.conversation.SetConversationMinSeq:input_type -> openim.conversation.SetConversationMinSeqReq
	24, // 56: openim.conversation.conversation.GetConversationIDs:input_type -> openim.conversation.GetConversationIDsReq
	26, // 57: openim.conversation.conversation.SetConversations:input_type -> openim.conversation.SetConversationsReq
	28, // 58: openim.conversation.conversation.GetUserConversationIDsHash:input_type -> openim.conversation.GetUserConversationIDsHashReq
	30, // 59: openim.conversation.conversation.GetConversationsByConversationID:input_type -> openim.conversation.GetConversationsByConversationIDReq
	32, // 60: openim.conversation.conversation.GetConversationOfflinePushUserIDs:input_type -> openim.conversation.GetConversationOfflinePushUserIDsReq
	34, // 61: openim.conversation.conversation.GetConversationNotReceiveMessageUserIDs:input_type -> openim.conversation.GetConversationNotReceiveMessageUserIDsReq
	36, // 62: openim.conversation.conversation.UpdateConversation:input_type -> openim.conversation.UpdateConversationReq
	38, // 63: openim.conversation.conversation.GetFullOwnerConversationIDs:input_type -> openim.conversation.GetFullOwnerConversationIDsReq
	40, // 64: openim.conversation.conversation.GetIncrementalConversation:input_type -> openim.conversation.GetIncrementalConversationReq
	42, // 65: openim.conversation.conversation.GetOwnerConversation:input_type -> openim.conversation.GetOwnerConversationReq
	44, // 66: openim.conversation.conversation.GetConversationsNeedClearMsg:input_type -> openim.conversation.GetConversationsNeedClearMsgReq
	46, // 67: openim.conversation.conversation.GetNotNotifyConversationIDs:input_type -> openim.conversation.GetNotNotifyConversationIDsReq
	48, // 68: openim.conversation.conversation.GetPinnedConversationIDs:input_type -> openim.conversation.GetPinnedConversationIDsReq
	50, // 69: openim.conversation.conversation.MarkConversation:input_type -> openim.conversation.MarkConversationReq
	52, // 70: openim.conversation.conversation.MarkConversationAsUnread:input_type -> openim.conversation.MarkConversationAsUnreadReq
	54, // 71: openim.conversation.conversation.ClearUserConversationMsg:input_type -> openim.conversation.ClearUserConversationMsgReq
	56, // 72: openim.conversation.conversation.UpdateConversationsByUser:input_type -> openim.conversation.UpdateConversationsByUserReq
	58, // 73: openim.conversation.conversation.DeleteConversations:input_type -> openim.conversation.DeleteConversationsReq
	62, // 74: openim.conversation.conversation.InitConversationGroups:input_type -> openim.conversation.InitConversationGroupsReq
	64, // 75: openim.conversation.conversation.GetAllConversationGroups:input_type -> openim.conversation.GetAllConversationGroupsReq
	66, // 76: openim.conversation.conversation.GetVisibleConversationGroups:input_type -> openim.conversation.GetVisibleConversationGroupsReq
	68, // 77: openim.conversation.conversation.CreateConversationGroup:input_type -> openim.conversation.CreateConversationGroupReq
	70, // 78: openim.conversation.conversation.UpdateConversationGroup:input_type -> openim.conversation.UpdateConversationGroupReq
	72, // 79: openim.conversation.conversation.DeleteConversationGroup:input_type -> openim.conversation.DeleteConversationGroupReq
	74, // 80: openim.conversation.conversation.UpdateConversationGroupSort:input_type -> openim.conversation.UpdateConversationGroupSortReq
	76, // 81: openim.conversation.conversation.SetConversationGroupVisibility:input_type -> openim.conversation.SetConversationGroupVisibilityReq
	78, // 82: openim.conversation.conversation.AddConversationsToGroup:input_type -> openim.conversation.AddConversationsToGroupReq
	80, // 83: openim.conversation.conversation.RemoveConversationsFromGroup:input_type -> openim.conversation.RemoveConversationsFromGroupReq
	82, // 84: openim.conversation.conversation.GetConversationIDsByGroupID:input_type -> openim.conversation.GetConversationIDsByGroupIDReq
	5,  // 85: openim.conversation.conversation.GetConversation:output_type -> openim.conversation.GetConversationResp
	7,  // 86: openim.conversation.conversation.GetSortedConversationList:output_type -> openim.conversation.GetSortedConversationListResp
	13, // 87: openim.conversation.conversation.GetAllConversations:output_type -> openim.conversation.GetAllConversationsResp
	11, // 88: openim.conversation.conversation.GetConversations:output_type -> openim.conversation.GetConversationsResp
	3,  // 89: openim.conversation.conversation.SetConversation:output_type -> openim.conversation.SetConversationResp
	15, // 90: openim.conversation.conversation.GetRecvMsgNotNotifyUserIDs:output_type -> openim.conversation.GetRecvMsgNotNotifyUserIDsResp
	17, // 91: openim.conversation.conversation.CreateSingleChatConversations:output_type -> openim.conversation.CreateSingleChatConversationsResp
	19, // 92: openim.conversation.conversation.CreateGroupChatConversations:output_type -> openim.conversation.CreateGroupChatConversationsResp
	21, // 93: openim.conversation.conversation.SetConversationMaxSeq:output_type -> openim.conversation.SetConversationMaxSeqResp
	23, // 94: openim.conversation.conversation.SetConversationMinSeq:output_type -> openim.conversation.SetConversationMinSeqResp
	25, // 95: openim.conversation.conversation.GetConversationIDs:output_type -> openim.conversation.GetConversationIDsResp
	27, // 96: openim.conversation.conversation.SetConversations:output_type -> openim.conversation.SetConversationsResp
	29, // 97: openim.conversation.conversation.GetUserConversationIDsHash:output_type -> openim.conversation.GetUserConversationIDsHashResp
	31, // 98: openim.conversation.conversation.GetConversationsByConversationID:output_type -> openim.conversation.GetConversationsByConversationIDResp
	33, // 99: openim.conversation.conversation.GetConversationOfflinePushUserIDs:output_type -> openim.conversation.GetConversationOfflinePushUserIDsResp
	35, // 100: openim.conversation.conversation.GetConversationNotReceiveMessageUserIDs:output_type -> openim.conversation.GetConversationNotReceiveMessageUserIDsResp
	37, // 101: openim.conversation.conversation.UpdateConversation:output_type -> openim.conversation.UpdateConversationResp
	39, // 102: openim.conversation.conversation.GetFullOwnerConversationIDs:output_type -> openim.conversation.GetFullOwnerConversationIDsResp
	41, // 103: openim.conversation.conversation.GetIncrementalConversation:output_type -> openim.conversation.GetIncrementalConversationResp
	43, // 104: openim.conversation.conversation.GetOwnerConversation:output_type -> openim.conversation.GetOwnerConversationResp
	45, // 105: openim.conversation.conversation.GetConversationsNeedClearMsg:output_type -> openim.conversation.GetConversationsNeedClearMsgResp
	47, // 106: openim.conversation.conversation.GetNotNotifyConversationIDs:output_type -> openim.conversation.GetNotNotifyConversationIDsResp
	49, // 107: openim.conversation.conversation.GetPinnedConversationIDs:output_type -> openim.conversation.GetPinnedConversationIDsResp
	51, // 108: openim.conversation.conversation.MarkConversation:output_type -> openim.conversation.MarkConversationResp
	53, // 109: openim.conversation.conversation.MarkConversationAsUnread:output_type -> openim.conversation.MarkConversationAsUnreadResp
	55, // 110: openim.conversation.conversation.ClearUserConversationMsg:output_type -> openim.conversation.ClearUserConversationMsgResp
	57, // 111: openim.conversation.conversation.UpdateConversationsByUser:output_type -> openim.conversation.UpdateConversationsByUserResp
	59, // 112: openim.conversation.conversation.DeleteConversations:output_type -> openim.conversation.DeleteConversationsResp
	63, // 113: openim.conversation.conversation.InitConversationGroups:output_type -> openim.conversation.InitConversationGroupsResp
	65, // 114: openim.conversation.conversation.GetAllConversationGroups:output_type -> openim.conversation.GetAllConversationGroupsResp
	67, // 115: openim.conversation.conversation.GetVisibleConversationGroups:output_type -> openim.conversation.GetVisibleConversationGroupsResp
	69, // 116: openim.conversation.conversation.CreateConversationGroup:output_type -> openim.conversation.CreateConversationGroupResp
	71, // 117: openim.conversation.conversation.UpdateConversationGroup:output_type -> openim.conversation.UpdateConversationGroupResp
	73, // 118: openim.conversation.conversation.DeleteConversationGroup:output_type -> openim.conversation.DeleteConversationGroupResp
	75, // 119: openim.conversation.conversation.UpdateConversationGroupSort:output_type -> openim.conversation.UpdateConversationGroupSortResp
	77, // 120: openim.conversation.conversation.SetConversationGroupVisibility:output_type -> openim.conversation.SetConversationGroupVisibilityResp
	79, // 121: openim.conversation.conversation.AddConversationsToGroup:output_type -> openim.conversation.AddConversationsToGroupResp
	81, // 122: openim.conversation.conversation.RemoveConversationsFromGroup:output_type -> openim.conversation.RemoveConversationsFromGroupResp
	83, // 123: openim.conversation.conversation.GetConversationIDsByGroupID:output_type -> openim.conversation.GetConversationIDsByGroupIDResp
