...
const (
	...
	Friend_AddFriendCategory_FullMethodName              = "/openim.relation.friend/AddFriendCategory"
)
...
type FriendClient interface {
	...
	AddFriendCategory(ctx context.Context, in *AddFriendCategoryReq, opts ...grpc.CallOption) (*AddFriendCategoryResp, error)
}
...
func (c *friendClient) AddFriendCategory(ctx context.Context, in *AddFriendCategoryReq, opts ...grpc.CallOption) (*AddFriendCategoryResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddFriendCategoryResp)
	err := c.cc.Invoke(ctx, Friend_AddFriendCategory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FriendServer interface {
	...
	// 定义一个 AddFriendCategory 的 RPC 方法
	AddFriendCategory(context.Context, *AddFriendCategoryReq) (*AddFriendCategoryResp, error)
...
func (UnimplementedFriendServer) AddFriendCategory(context.Context, *AddFriendCategoryReq) (*AddFriendCategoryResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddFriendCategory not implemented")
}
...
func _Friend_AddFriendCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddFriendCategoryReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FriendServer).AddFriendCategory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Friend_AddFriendCategory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FriendServer).AddFriendCategory(ctx, req.(*AddFriendCategoryReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Friend_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddFriendCategory",
			Handler:    _Friend_AddFriendCategory_Handler,
		},
	},
