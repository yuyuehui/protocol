...
var file_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 110)
var file_user_user_proto_goTypes = []any{
	...
	(*AccountCheckRespSingleUserStatus)(nil),  // 105: openim.user.accountCheckResp.singleUserStatus
	nil,                                       // 106: openim.user.userRegisterCountResp.CountEntry
	nil,                                       // 107: openim.user.sortQueryReq.UserIDNameEntry
	nil,                                       // 108: openim.user.getUserClientConfigResp.ConfigsEntry
	nil,                                       // 109: openim.user.setUserClientConfigReq.ConfigsEntry
	(*sdkws.RequestPagination)(nil),           // 110: openim.sdkws.RequestPagination
	(*sdkws.UserInfo)(nil),                    // 111: openim.sdkws.UserInfo
	(*sdkws.UserInfoWithEx)(nil),              // 112: openim.sdkws.UserInfoWithEx
...
var file_user_user_proto_depIdxs = []int32{
	110, // 0: openim.user.getAllUserIDReq.pagination:type_name -> openim.sdkws.RequestPagination
	105, // 1: openim.user.accountCheckResp.results:type_name -> openim.user.accountCheckResp.singleUserStatus
	111, // 2: openim.user.getDesignateUsersResp.usersInfo:type_name -> openim.sdkws.UserInfo
	111, // 3: openim.user.updateUserInfoReq.userInfo:type_name -> openim.sdkws.UserInfo
	112, // 4: openim.user.updateUserInfoExReq.userInfo:type_name -> openim.sdkws.UserInfoWithEx
	113, // 5: openim.user.setConversationReq.conversation:type_name -> openim.conversation.Conversation
	113, // 6: openim.user.getConversationResp.conversation:type_name -> openim.conversation.Conversation
	113, // 7: openim.user.getConversationsResp.conversations:type_name -> openim.conversation.Conversation
	113, // 8: openim.user.getAllConversationsResp.conversations:type_name -> openim.conversation.Conversation
	113, // 9: openim.user.batchSetConversationsReq.conversations:type_name -> openim.conversation.Conversation
	110, // 10: openim.user.getPaginationUsersReq.pagination:type_name -> openim.sdkws.RequestPagination
	111, // 11: openim.user.getPaginationUsersResp.users:type_name -> openim.sdkws.UserInfo
	111, // 12: openim.user.userRegisterReq.users:type_name -> openim.sdkws.UserInfo
	106, // 13: openim.user.userRegisterCountResp.count:type_name -> openim.user.userRegisterCountResp.CountEntry
	...
	114, // 19: openim.user.processUserCommandAddReq.value:type_name -> openim.protobuf.StringValue
	114, // 20: openim.user.processUserCommandAddReq.ex:type_name -> openim.protobuf.StringValue
	114, // 21: openim.user.processUserCommandUpdateReq.value:type_name -> openim.protobuf.StringValue
	114, // 22: openim.user.processUserCommandUpdateReq.ex:type_name -> openim.protobuf.StringValue
	...
	110, // 25: openim.user.searchNotificationAccountReq.pagination:type_name -> openim.sdkws.RequestPagination
	...
	107, // 28: openim.user.sortQueryReq.userIDName:type_name -> openim.user.sortQueryReq.UserIDNameEntry
	111, // 29: openim.user.sortQueryResp.users:type_name -> openim.sdkws.UserInfo
	37,  // 30: openim.user.getAllOnlineUsersResp.StatusList:type_name -> openim.user.onlineStatus
	108, // 31: openim.user.getUserClientConfigResp.configs:type_name -> openim.user.getUserClientConfigResp.ConfigsEntry
	109, // 32: openim.user.setUserClientConfigReq.configs:type_name -> openim.user.setUserClientConfigReq.ConfigsEntry
	110, // 33: openim.user.pageUserClientConfigReq.pagination:type_name -> openim.sdkws.RequestPagination
	...
	4,   // 43: openim.user.user.getDesignateUsers:input_type -> openim.user.getDesignateUsersReq
	6,   // 44: openim.user.user.updateUserInfo:input_type -> openim.user.updateUserInfoReq
	8,   // 45: openim.user.user.updateUserInfoEx:input_type -> openim.user.updateUserInfoExReq
	10,  // 46: openim.user.user.setGlobalRecvMessageOpt:input_type -> openim.user.setGlobalRecvMessageOptReq
	28,  // 47: openim.user.user.getGlobalRecvMessageOpt:input_type -> openim.user.getGlobalRecvMessageOptReq
	2,   // 48: openim.user.user.accountCheck:input_type -> openim.user.accountCheckReq
	24,  // 49: openim.user.user.getPaginationUsers:input_type -> openim.user.getPaginationUsersReq
	26,  // 50: openim.user.user.userRegister:input_type -> openim.user.userRegisterReq
	0,   // 51: openim.user.user.getAllUserID:input_type -> openim.user.getAllUserIDReq
	30,  // 52: openim.user.user.userRegisterCount:input_type -> openim.user.userRegisterCountReq
	32,  // 53: openim.user.user.subscribeOrCancelUsersStatus:input_type -> openim.user.subscribeOrCancelUsersStatusReq
	34,  // 54: openim.user.user.getSubscribeUsersStatus:input_type -> openim.user.getSubscribeUsersStatusReq
	38,  // 55: openim.user.user.getUserStatus:input_type -> openim.user.getUserStatusReq
	40,  // 56: openim.user.user.setUserStatus:input_type -> openim.user.setUserStatusReq
	45,  // 57: openim.user.user.processUserCommandAdd:input_type -> openim.user.processUserCommandAddReq
	49,  // 58: openim.user.user.processUserCommandUpdate:input_type -> openim.user.processUserCommandUpdateReq
	47,  // 59: openim.user.user.processUserCommandDelete:input_type -> openim.user.processUserCommandDeleteReq
	51,  // 60: openim.user.user.processUserCommandGet:input_type -> openim.user.processUserCommandGetReq
	54,  // 61: openim.user.user.processUserCommandGetAll:input_type -> openim.user.processUserCommandGetAllReq
	57,  // 62: openim.user.user.addNotificationAccount:input_type -> openim.user.addNotificationAccountReq
	59,  // 63: openim.user.user.updateNotificationAccountInfo:input_type -> openim.user.updateNotificationAccountInfoReq
	61,  // 64: openim.user.user.searchNotificationAccount:input_type -> openim.user.searchNotificationAccountReq
	64,  // 65: openim.user.user.getNotificationAccount:input_type -> openim.user.getNotificationAccountReq
	66,  // 66: openim.user.user.sortQuery:input_type -> openim.user.sortQueryReq
	43,  // 67: openim.user.user.setUserOnlineStatus:input_type -> openim.user.setUserOnlineStatusReq
	68,  // 68: openim.user.user.getAllOnlineUsers:input_type -> openim.user.getAllOnlineUsersReq
	70,  // 69: openim.user.user.getUserClientConfig:input_type -> openim.user.getUserClientConfigReq
	72,  // 70: openim.user.user.setUserClientConfig:input_type -> openim.user.setUserClientConfigReq
	74,  // 71: openim.user.user.delUserClientConfig:input_type -> openim.user.delUserClientConfigReq
	76,  // 72: openim.user.user.pageUserClientConfig:input_type -> openim.user.pageUserClientConfigReq
	79,  // 73: openim.user.user.saveUserEmoji:input_type -> openim.user.saveUserEmojiReq
	81,  // 74: openim.user.user.deleteUserEmoji:input_type -> openim.user.deleteUserEmojiReq
	83,  // 75: openim.user.user.getUserEmoji:input_type -> openim.user.getUserEmojiReq
	85,  // 76: openim.user.user.getAllUserEmojis:input_type -> openim.user.getAllUserEmojisReq
	89,  // 77: openim.user.user.getQuickReplies:input_type -> openim.user.getQuickRepliesReq
	91,  // 78: openim.user.user.syncQuickReplies:input_type -> openim.user.syncQuickRepliesReq
	93,  // 79: openim.user.user.upsertQuickReply:input_type -> openim.user.upsertQuickReplyReq
	95,  // 80: openim.user.user.deleteQuickReply:input_type -> openim.user.deleteQuickReplyReq
	97,  // 81: openim.user.user.pinQuickReply:input_type -> openim.user.pinQuickReplyReq
	99,  // 82: openim.user.user.refreshFrequentReplies:input_type -> openim.user.refreshFrequentRepliesReq
	101, // 83: openim.user.user.submitRefreshResult:input_type -> openim.user.submitRefreshResultReq
	103, // 84: openim.user.user.getRefreshStatus:input_type -> openim.user.getRefreshStatusReq
	...
	33,  // 95: openim.user.user.subscribeOrCancelUsersStatus:output_type -> openim.user.subscribeOrCancelUsersStatusResp
	35,  // 96: openim.user.user.getSubscribeUsersStatus:output_type -> openim.user.getSubscribeUsersStatusResp
	39,  // 97: openim.user.user.getUserStatus:output_type -> openim.user.getUserStatusResp
	41,  // 98: openim.user.user.setUserStatus:output_type -> openim.user.setUserStatusResp
	46,  // 99: openim.user.user.processUserCommandAdd:output_type -> openim.user.processUserCommandAddResp
	50,  // 100: openim.user.user.processUserCommandUpdate:output_type -> openim.user.processUserCommandUpdateResp
	48,  // 101: openim.user.user.processUserCommandDelete:output_type -> openim.user.processUserCommandDeleteResp
	53,  // 102: openim.user.user.processUserCommandGet:output_type -> openim.user.processUserCommandGetResp
	56,  // 103: openim.user.user.processUserCommandGetAll:output_type -> openim.user.processUserCommandGetAllResp
	58,  // 104: openim.user.user.addNotificationAccount:output_type -> openim.user.addNotificationAccountResp
	60,  // 105: openim.user.user.updateNotificationAccountInfo:output_type -> openim.user.updateNotificationAccountInfoResp
	63,  // 106: openim.user.user.searchNotificationAccount:output_type -> openim.user.searchNotificationAccountResp
	65,  // 107: openim.user.user.getNotificationAccount:output_type -> openim.user.getNotificationAccountResp
	67,  // 108: openim.user.user.sortQuery:output_type -> openim.user.sortQueryResp
	44,  // 109: openim.user.user.setUserOnlineStatus:output_type -> openim.user.setUserOnlineStatusResp
	69,  // 110: openim.user.user.getAllOnlineUsers:output_type -> openim.user.getAllOnlineUsersResp
	71,  // 111: openim.user.user.getUserClientConfig:output_type -> openim.user.getUserClientConfigResp
	73,  // 112: openim.user.user.setUserClientConfig:output_type -> openim.user.setUserClientConfigResp
	75,  // 113: openim.user.user.delUserClientConfig:output_type -> openim.user.delUserClientConfigResp
	77,  // 114: openim.user.user.pageUserClientConfig:output_type -> openim.user.pageUserClientConfigResp
	80,  // 115: openim.user.user.saveUserEmoji:output_type -> openim.user.saveUserEmojiResp
	82,  // 116: openim.user.user.deleteUserEmoji:output_type -> openim.user.deleteUserEmojiResp
	84,  // 117: openim.user.user.getUserEmoji:output_type -> openim.user.getUserEmojiResp
	86,  // 118: openim.user.user.getAllUserEmojis:output_type -> openim.user.getAllUserEmojisResp
	90,  // 119: openim.user.user.getQuickReplies:output_type -> openim.user.getQuickRepliesResp
	92,  // 120: openim.user.user.syncQuickReplies:output_type -> openim.user.syncQuickRepliesResp
	94,  // 121: openim.user.user.upsertQuickReply:output_type -> openim.user.upsertQuickReplyResp
	96,  // 122: openim.user.user.deleteQuickReply:output_type -> openim.user.deleteQuickReplyResp
	98,  // 123: openim.user.user.pinQuickReply:output_type -> openim.user.pinQuickReplyResp
	100, // 124: openim.user.user.refreshFrequentReplies:output_type -> openim.user.refreshFrequentRepliesResp
	102, // 125: openim.user.user.submitRefreshResult:output_type -> openim.user.submitRefreshResultResp
	104, // 126: openim.user.user.getRefreshStatus:output_type -> openim.user.getRefreshStatusResp
