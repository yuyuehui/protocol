...
var file_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 92)
var file_user_user_proto_goTypes = []any{
	...
	(*AccountCheckRespSingleUserStatus)(nil),  // 87: openim.user.accountCheckResp.singleUserStatus
	nil,                                       // 88: openim.user.userRegisterCountResp.CountEntry
	nil,                                       // 89: openim.user.sortQueryReq.UserIDNameEntry
	nil,                                       // 90: openim.user.getUserClientConfigResp.ConfigsEntry
	nil,                                       // 91: openim.user.setUserClientConfigReq.ConfigsEntry
	(*sdkws.RequestPagination)(nil),           // 92: openim.sdkws.RequestPagination
	(*sdkws.UserInfo)(nil),                    // 93: openim.sdkws.UserInfo
	(*sdkws.UserInfoWithEx)(nil),              // 94: openim.sdkws.UserInfoWithEx
	(*conversation.Conversation)(nil),         // 95: openim.conversation.Conversation
	(*wrapperspb.StringValue)(nil),            // 96: openim.protobuf.StringValue
}
var file_user_user_proto_depIdxs = []int32{
	92, // 0: openim.user.getAllUserIDReq.pagination:type_name -> openim.sdkws.RequestPagination
	87, // 1: openim.user.accountCheckResp.results:type_name -> openim.user.accountCheckResp.singleUserStatus
	93, // 2: openim.user.getDesignateUsersResp.usersInfo:type_name -> openim.sdkws.UserInfo
	93, // 3: openim.user.updateUserInfoReq.userInfo:type_name -> openim.sdkws.UserInfo
	94, // 4: openim.user.updateUserInfoExReq.userInfo:type_name -> openim.sdkws.UserInfoWithEx
	95, // 5: openim.user.setConversationReq.conversation:type_name -> openim.conversation.Conversation
	95, // 6: openim.user.getConversationResp.conversation:type_name -> openim.conversation.Conversation
	95, // 7: openim.user.getConversationsResp.conversations:type_name -> openim.conversation.Conversation
	95, // 8: openim.user.getAllConversationsResp.conversations:type_name -> openim.conversation.Conversation
	95, // 9: openim.user.batchSetConversationsReq.conversations:type_name -> openim.conversation.Conversation
	92, // 10: openim.user.getPaginationUsersReq.pagination:type_name -> openim.sdkws.RequestPagination
	93, // 11: openim.user.getPaginationUsersResp.users:type_name -> openim.sdkws.UserInfo
	93, // 12: openim.user.userRegisterReq.users:type_name -> openim.sdkws.UserInfo
	88, // 13: openim.user.userRegisterCountResp.count:type_name -> openim.user.userRegisterCountResp.CountEntry
	...
	96, // 19: openim.user.processUserCommandAddReq.value:type_name -> openim.protobuf.StringValue
	96, // 20: openim.user.processUserCommandAddReq.ex:type_name -> openim.protobuf.StringValue
	96, // 21: openim.user.processUserCommandUpdateReq.value:type_name -> openim.protobuf.StringValue
	96, // 22: openim.user.processUserCommandUpdateReq.ex:type_name -> openim.protobuf.StringValue
	...
	92, // 25: openim.user.searchNotificationAccountReq.pagination:type_name -> openim.sdkws.RequestPagination
	...
	89, // 28: openim.user.sortQueryReq.userIDName:type_name -> openim.user.sortQueryReq.UserIDNameEntry
	93, // 29: openim.user.sortQueryResp.users:type_name -> openim.sdkws.UserInfo
	37, // 30: openim.user.getAllOnlineUsersResp.StatusList:type_name -> openim.user.onlineStatus
	90, // 31: openim.user.getUserClientConfigResp.configs:type_name -> openim.user.getUserClientConfigResp.ConfigsEntry
	91, // 32: openim.user.setUserClientConfigReq.configs:type_name -> openim.user.setUserClientConfigReq.ConfigsEntry
	92, // 33: openim.user.pageUserClientConfigReq.pagination:type_name -> openim.sdkws.RequestPagination
	...
	38, // 48: openim.user.user.getUserStatus:input_type -> openim.user.getUserStatusReq
	40, // 49: openim.user.user.setUserStatus:input_type -> openim.user.setUserStatusReq
	45, // 50: openim.user.user.processUserCommandAdd:input_type -> openim.user.processUserCommandAddReq
	49, // 51: openim.user.user.processUserCommandUpdate:input_type -> openim.user.processUserCommandUpdateReq
	47, // 52: openim.user.user.processUserCommandDelete:input_type -> openim.user.processUserCommandDeleteReq
	51, // 53: openim.user.user.processUserCommandGet:input_type -> openim.user.processUserCommandGetReq
	54, // 54: openim.user.user.processUserCommandGetAll:input_type -> openim.user.processUserCommandGetAllReq
	57, // 55: openim.user.user.addNotificationAccount:input_type -> openim.user.addNotificationAccountReq
	59, // 56: openim.user.user.updateNotificationAccountInfo:input_type -> openim.user.updateNotificationAccountInfoReq
	61, // 57: openim.user.user.searchNotificationAccount:input_type -> openim.user.searchNotificationAccountReq
	64, // 58: openim.user.user.getNotificationAccount:input_type -> openim.user.getNotificationAccountReq
	66, // 59: openim.user.user.sortQuery:input_type -> openim.user.sortQueryReq
	43, // 60: openim.user.user.setUserOnlineStatus:input_type -> openim.user.setUserOnlineStatusReq
	68, // 61: openim.user.user.getAllOnlineUsers:input_type -> openim.user.getAllOnlineUsersReq
	70, // 62: openim.user.user.getUserClientConfig:input_type -> openim.user.getUserClientConfigReq
	72, // 63: openim.user.user.setUserClientConfig:input_type -> openim.user.setUserClientConfigReq
	74, // 64: openim.user.user.delUserClientConfig:input_type -> openim.user.delUserClientConfigReq
	76, // 65: openim.user.user.pageUserClientConfig:input_type -> openim.user.pageUserClientConfigReq
	79, // 66: openim.user.user.saveUserEmoji:input_type -> openim.user.saveUserEmojiReq
	81, // 67: openim.user.user.deleteUserEmoji:input_type -> openim.user.deleteUserEmojiReq
	83, // 68: openim.user.user.getUserEmoji:input_type -> openim.user.getUserEmojiReq
	85, // 69: openim.user.user.getAllUserEmojis:input_type -> openim.user.getAllUserEmojisReq
	...
	39, // 82: openim.user.user.getUserStatus:output_type -> openim.user.getUserStatusResp
	41, // 83: openim.user.user.setUserStatus:output_type -> openim.user.setUserStatusResp
	46, // 84: openim.user.user.processUserCommandAdd:output_type -> openim.user.processUserCommandAddResp
	50, // 85: openim.user.user.processUserCommandUpdate:output_type -> openim.user.processUserCommandUpdateResp
	48, // 86: openim.user.user.processUserCommandDelete:output_type -> openim.user.processUserCommandDeleteResp
	53, // 87: openim.user.user.processUserCommandGet:output_type -> openim.user.processUserCommandGetResp
	56, // 88: openim.user.user.processUserCommandGetAll:output_type -> openim.user.processUserCommandGetAllResp
	58, // 89: openim.user.user.addNotificationAccount:output_type -> openim.user.addNotificationAccountResp
	60, // 90: openim.user.user.updateNotificationAccountInfo:output_type -> openim.user.updateNotificationAccountInfoResp
	63, // 91: openim.user.user.searchNotificationAccount:output_type -> openim.user.searchNotificationAccountResp
	65, // 92: openim.user.user.getNotificationAccount:output_type -> openim.user.getNotificationAccountResp
	67, // 93: openim.user.user.sortQuery:output_type -> openim.user.sortQueryResp
	44, // 94: openim.user.user.setUserOnlineStatus:output_type -> openim.user.setUserOnlineStatusResp
	69, // 95: openim.user.user.getAllOnlineUsers:output_type -> openim.user.getAllOnlineUsersResp
	71, // 96: openim.user.user.getUserClientConfig:output_type -> openim.user.getUserClientConfigResp
	73, // 97: openim.user.user.setUserClientConfig:output_type -> openim.user.setUserClientConfigResp
	75, // 98: openim.user.user.delUserClientConfig:output_type -> openim.user.delUserClientConfigResp
	77, // 99: openim.user.user.pageUserClientConfig:output_type -> openim.user.pageUserClientConfigResp
	80, // 100: openim.user.user.saveUserEmoji:output_type -> openim.user.saveUserEmojiResp
	82, // 101: openim.user.user.deleteUserEmoji:output_type -> openim.user.deleteUserEmojiResp
	84, // 102: openim.user.user.getUserEmoji:output_type -> openim.user.getUserEmojiResp
	86, // 103: openim.user.user.getAllUserEmojis:output_type -> openim.user.getAllUserEmojisResp
