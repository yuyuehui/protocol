...
const file_user_user_proto_rawDesc = "" +
	...
	"\x19batchUpsertAIQuickReplies\x12).openim.user.batchUpsertAIQuickRepliesReq\x1a*.openim.user.batchUpsertAIQuickRepliesRespB$Z\"github.com/openimsdk/protocol/userb\x06proto3"
...
var file_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 112)
var file_user_user_proto_goTypes = []any{
	...
	(*AccountCheckRespSingleUserStatus)(nil),  // 107: openim.user.accountCheckResp.singleUserStatus
	nil,                                       // 108: openim.user.userRegisterCountResp.CountEntry
	nil,                                       // 109: openim.user.sortQueryReq.UserIDNameEntry
	nil,                                       // 110: openim.user.getUserClientConfigResp.ConfigsEntry
	nil,                                       // 111: openim.user.setUserClientConfigReq.ConfigsEntry
	(*sdkws.RequestPagination)(nil),           // 112: openim.sdkws.RequestPagination
	(*sdkws.UserInfo)(nil),                    // 113: openim.sdkws.UserInfo
	(*sdkws.UserInfoWithEx)(nil),              // 114: openim.sdkws.UserInfoWithEx
	(*conversation.Conversation)(nil),         // 115: openim.conversation.Conversation
	(*wrapperspb.StringValue)(nil),            // 116: openim.protobuf.StringValue
}
var file_user_user_proto_depIdxs = []int32{
	112, // 0: openim.user.getAllUserIDReq.pagination:type_name -> openim.sdkws.RequestPagination
	107, // 1: openim.user.accountCheckResp.results:type_name -> openim.user.accountCheckResp.singleUserStatus
	113, // 2: openim.user.getDesignateUsersResp.usersInfo:type_name -> openim.sdkws.UserInfo
	113, // 3: openim.user.updateUserInfoReq.userInfo:type_name -> openim.sdkws.UserInfo
	114, // 4: openim.user.updateUserInfoExReq.userInfo:type_name -> openim.sdkws.UserInfoWithEx
	115, // 5: openim.user.setConversationReq.conversation:type_name -> openim.conversation.Conversation
	115, // 6: openim.user.getConversationResp.conversation:type_name -> openim.conversation.Conversation
	115, // 7: openim.user.getConversationsResp.conversations:type_name -> openim.conversation.Conversation
	115, // 8: openim.user.getAllConversationsResp.conversations:type_name -> openim.conversation.Conversation
	115, // 9: openim.user.batchSetConversationsReq.conversations:type_name -> openim.conversation.Conversation
	112, // 10: openim.user.getPaginationUsersReq.pagination:type_name -> openim.sdkws.RequestPagination
	113, // 11: openim.user.getPaginationUsersResp.users:type_name -> openim.sdkws.UserInfo
	113, // 12: openim.user.userRegisterReq.users:type_name -> openim.sdkws.UserInfo
	108, // 13: openim.user.userRegisterCountResp.count:type_name -> openim.user.userRegisterCountResp.CountEntry
	...
	116, // 19: openim.user.processUserCommandAddReq.value:type_name -> openim.protobuf.StringValue
	116, // 20: openim.user.processUserCommandAddReq.ex:type_name -> openim.protobuf.StringValue
	116, // 21: openim.user.processUserCommandUpdateReq.value:type_name -> openim.protobuf.StringValue
	116, // 22: openim.user.processUserCommandUpdateReq.ex:type_name -> openim.protobuf.StringValue
	...
	112, // 25: openim.user.searchNotificationAccountReq.pagination:type_name -> openim.sdkws.RequestPagination
	...
	109, // 28: openim.user.sortQueryReq.userIDName:type_name -> openim.user.sortQueryReq.UserIDNameEntry
	113, // 29: openim.user.sortQueryResp.users:type_name -> openim.sdkws.UserInfo
	37,  // 30: openim.user.getAllOnlineUsersResp.StatusList:type_name -> openim.user.onlineStatus
	110, // 31: openim.user.getUserClientConfigResp.configs:type_name -> openim.user.getUserClientConfigResp.ConfigsEntry
	111, // 32: openim.user.setUserClientConfigReq.configs:type_name -> openim.user.setUserClientConfigReq.ConfigsEntry
	112, // 33: openim.user.pageUserClientConfigReq.pagination:type_name -> openim.sdkws.RequestPagination
	...
	4,   // 44: openim.user.user.getDesignateUsers:input_type -> openim.user.getDesignateUsersReq
	6,   // 45: openim.user.user.updateUserInfo:input_type -> openim.user.updateUserInfoReq
	8,   // 46: openim.user.user.updateUserInfoEx:input_type -> openim.user.updateUserInfoExReq
	10,  // 47: openim.user.user.setGlobalRecvMessageOpt:input_type -> openim.user.setGlobalRecvMessageOptReq
	28,  // 48: openim.user.user.getGlobalRecvMessageOpt:input_type -> openim.user.getGlobalRecvMessageOptReq
	2,   // 49: openim.user.user.accountCheck:input_type -> openim.user.accountCheckReq
	24,  // 50: openim.user.user.getPaginationUsers:input_type -> openim.user.getPaginationUsersReq
	26,  // 51: openim.user.user.userRegister:input_type -> openim.user.userRegisterReq
	0,   // 52: openim.user.user.getAllUserID:input_type -> openim.user.getAllUserIDReq
	30,  // 53: openim.user.user.userRegisterCount:input_type -> openim.user.userRegisterCountReq
	32,  // 54: openim.user.user.subscribeOrCancelUsersStatus:input_type -> openim.user.subscribeOrCancelUsersStatusReq
	34,  // 55: openim.user.user.getSubscribeUsersStatus:input_type -> openim.user.getSubscribeUsersStatusReq
	38,  // 56: openim.user.user.getUserStatus:input_type -> openim.user.getUserStatusReq
	40,  // 57: openim.user.user.setUserStatus:input_type -> openim.user.setUserStatusReq
	45,  // 58: openim.user.user.processUserCommandAdd:input_type -> openim.user.processUserCommandAddReq
	49,  // 59: openim.user.user.processUserCommandUpdate:input_type -> openim.user.processUserCommandUpdateReq
	47,  // 60: openim.user.user.processUserCommandDelete:input_type -> openim.user.processUserCommandDeleteReq
	51,  // 61: openim.user.user.processUserCommandGet:input_type -> openim.user.processUserCommandGetReq
	54,  // 62: openim.user.user.processUserCommandGetAll:input_type -> openim.user.processUserCommandGetAllReq
	57,  // 63: openim.user.user.addNotificationAccount:input_type -> openim.user.addNotificationAccountReq
	59,  // 64: openim.user.user.updateNotificationAccountInfo:input_type -> openim.user.updateNotificationAccountInfoReq
	61,  // 65: openim.user.user.searchNotificationAccount:input_type -> openim.user.searchNotificationAccountReq
	64,  // 66: openim.user.user.getNotificationAccount:input_type -> openim.user.getNotificationAccountReq
	66,  // 67: openim.user.user.sortQuery:input_type -> openim.user.sortQueryReq
	43,  // 68: openim.user.user.setUserOnlineStatus:input_type -> openim.user.setUserOnlineStatusReq
	68,  // 69: openim.user.user.getAllOnlineUsers:input_type -> openim.user.getAllOnlineUsersReq
	70,  // 70: openim.user.user.getUserClientConfig:input_type -> openim.user.getUserClientConfigReq
	72,  // 71: openim.user.user.setUserClientConfig:input_type -> openim.user.setUserClientConfigReq
	74,  // 72: openim.user.user.delUserClientConfig:input_type -> openim.user.delUserClientConfigReq
	76,  // 73: openim.user.user.pageUserClientConfig:input_type -> openim.user.pageUserClientConfigReq
	79,  // 74: openim.user.user.saveUserEmoji:input_type -> openim.user.saveUserEmojiReq
	81,  // 75: openim.user.user.deleteUserEmoji:input_type -> openim.user.deleteUserEmojiReq
	83,  // 76: openim.user.user.getUserEmoji:input_type -> openim.user.getUserEmojiReq
	85,  // 77: openim.user.user.getAllUserEmojis:input_type -> openim.user.getAllUserEmojisReq
	89,  // 78: openim.user.user.getQuickReplies:input_type -> openim.user.getQuickRepliesReq
	91,  // 79: openim.user.user.syncQuickReplies:input_type -> openim.user.syncQuickRepliesReq
	93,  // 80: openim.user.user.upsertQuickReply:input_type -> openim.user.upsertQuickReplyReq
	95,  // 81: openim.user.user.deleteQuickReply:input_type -> openim.user.deleteQuickReplyReq
	97,  // 82: openim.user.user.pinQuickReply:input_type -> openim.user.pinQuickReplyReq
	99,  // 83: openim.user.user.refreshFrequentReplies:input_type -> openim.user.refreshFrequentRepliesReq
	101, // 84: openim.user.user.submitRefreshResult:input_type -> openim.user.submitRefreshResultReq
	103, // 85: openim.user.user.getRefreshStatus:input_type -> openim.user.getRefreshStatusReq
	105, // 86: openim.user.user.batchUpsertAIQuickReplies:input_type -> openim.user.batchUpsertAIQuickRepliesReq
	5,   // 87: openim.user.user.getDesignateUsers:output_type -> openim.user.getDesignateUsersResp
	7,   // 88: openim.user.user.updateUserInfo:output_type -> openim.user.updateUserInfoResp
	9,   // 89: openim.user.user.updateUserInfoEx:output_type -> openim.user.updateUserInfoExResp
	11,  // 90: openim.user.user.setGlobalRecvMessageOpt:output_type -> openim.user.setGlobalRecvMessageOptResp
	29,  // 91: openim.user.user.getGlobalRecvMessageOpt:output_type -> openim.user.getGlobalRecvMessageOptResp
	3,   // 92: openim.user.user.accountCheck:output_type -> openim.user.accountCheckResp
	25,  // 93: openim.user.user.getPaginationUsers:output_type -> openim.user.getPaginationUsersResp
	27,  // 94: openim.user.user.userRegister:output_type -> openim.user.userRegisterResp
	1,   // 95: openim.user.user.getAllUserID:output_type -> openim.user.getAllUserIDResp
	31,  // 96: openim.user.user.userRegisterCount:output_type -> openim.user.userRegisterCountResp
	33,  // 97: openim.user.user.subscribeOrCancelUsersStatus:output_type -> openim.user.subscribeOrCancelUsersStatusResp
	35,  // 98: openim.user.user.getSubscribeUsersStatus:output_type -> openim.user.getSubscribeUsersStatusResp
	39,  // 99: openim.user.user.getUserStatus:output_type -> openim.user.getUserStatusResp
	41,  // 100: openim.user.user.setUserStatus:output_type -> openim.user.setUserStatusResp
	46,  // 101: openim.user.user.processUserCommandAdd:output_type -> openim.user.processUserCommandAddResp
	50,  // 102: openim.user.user.processUserCommandUpdate:output_type -> openim.user.processUserCommandUpdateResp
	48,  // 103: openim.user.user.processUserCommandDelete:output_type -> openim.user.processUserCommandDeleteResp
	53,  // 104: openim.user.user.processUserCommandGet:output_type -> openim.user.processUserCommandGetResp
	56,  // 105: openim.user.user.processUserCommandGetAll:output_type -> openim.user.processUserCommandGetAllResp
	58,  // 106: openim.user.user.addNotificationAccount:output_type -> openim.user.addNotificationAccountResp
	60,  // 107: openim.user.user.updateNotificationAccountInfo:output_type -> openim.user.updateNotificationAccountInfoResp
	63,  // 108: openim.user.user.searchNotificationAccount:output_type -> openim.user.searchNotificationAccountResp
	65,  // 109: openim.user.user.getNotificationAccount:output_type -> openim.user.getNotificationAccountResp
	67,  // 110: openim.user.user.sortQuery:output_type -> openim.user.sortQueryResp
	44,  // 111: openim.user.user.setUserOnlineStatus:output_type -> openim.user.setUserOnlineStatusResp
	69,  // 112: openim.user.user.getAllOnlineUsers:output_type -> openim.user.getAllOnlineUsersResp
	71,  // 113: openim.user.user.getUserClientConfig:output_type -> openim.user.getUserClientConfigResp
	73,  // 114: openim.user.user.setUserClientConfig:output_type -> openim.user.setUserClientConfigResp
	75,  // 115: openim.user.user.delUserClientConfig:output_type -> openim.user.delUserClientConfigResp
	77,  // 116: openim.user.user.pageUserClientConfig:output_type -> openim.user.pageUserClientConfigResp
	80,  // 117: openim.user.user.saveUserEmoji:output_type -> openim.user.saveUserEmojiResp
	82,  // 118: openim.user.user.deleteUserEmoji:output_type -> openim.user.deleteUserEmojiResp
	84,  // 119: openim.user.user.getUserEmoji:output_type -> openim.user.getUserEmojiResp
	86,  // 120: openim.user.user.getAllUserEmojis:output_type -> openim.user.getAllUserEmojisResp
	90,  // 121: openim.user.user.getQuickReplies:output_type -> openim.user.getQuickRepliesResp
	92,  // 122: openim.user.user.syncQuickReplies:output_type -> openim.user.syncQuickRepliesResp
	94,  // 123: openim.user.user.upsertQuickReply:output_type -> openim.user.upsertQuickReplyResp
	96,  // 124: openim.user.user.deleteQuickReply:output_type -> openim.user.deleteQuickReplyResp
	98,  // 125: openim.user.user.pinQuickReply:output_type -> openim.user.pinQuickReplyResp
	100, // 126: openim.user.user.refreshFrequentReplies:output_type -> openim.user.refreshFrequentRepliesResp
	102, // 127: openim.user.user.submitRefreshResult:output_type -> openim.user.submitRefreshResultResp
	104, // 128: openim.user.user.getRefreshStatus:output_type -> openim.user.getRefreshStatusResp
	106, // 129: openim.user.user.batchUpsertAIQuickReplies:output_type -> openim.user.batchUpsertAIQuickRepliesResp
