...
func (UnimplementedUserServer) BatchUpsertAIQuickReplies(context.Context, *BatchUpsertAIQuickRepliesReq) (*BatchUpsertAIQuickRepliesResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchUpsertAIQuickReplies not implemented")
}
func (UnimplementedUserServer) GetSignatureList(context.Context, *GetSignatureListReq) (*GetSignatureListResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSignatureList not implemented")
}
