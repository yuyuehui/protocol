...
type MeetingScheduleInfo struct {
	...
	RoomInfo         *meeting_room.MeetingRoomInfo `protobuf:"bytes,25,opt,name=roomInfo,proto3" json:"roomInfo"`                 // 会议室详细信息（roomID 非空时填充）
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *MeetingScheduleInfo) GetRoomInfo() *meeting_room.MeetingRoomInfo {
	if x != nil {
		return x.RoomInfo
	}
	return nil
...
type CreateQuickMeetingReq struct {
	...
	GroupID        string                 `protobuf:"bytes,5,opt,name=groupID,proto3" json:"groupID"`        // 群ID，非空时向群内推送会议卡片消息
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *CreateQuickMeetingReq) GetGroupID() string {
	if x != nil {
		return x.GroupID
	}
	return ""
...
const file_livekit_meeting_livekit_meeting_proto_rawDesc = "" +
	...
	"\x17enableParticipantChange\x18\x06 \x01(\bR\x17enableParticipantChange\"\xd1\x01\n" +
	...
	"visibility\x12\x18\n" +
	"\agroupID\x18\x05 \x01(\tR\agroupID\"\x96\x01\n" +
