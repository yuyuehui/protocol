...
const (
	...
	Third_SpeechToText_FullMethodName            = "/openim.third.third/SpeechToText"
	Third_TranslateText_FullMethodName           = "/openim.third.third/TranslateText"
)
...
func (c *thirdClient) SpeechToText(ctx context.Context, in *SpeechToTextReq, opts ...grpc.CallOption) (*SpeechToTextResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SpeechToTextResp)
	err := c.cc.Invoke(ctx, Third_SpeechToText_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *thirdClient) TranslateText(ctx context.Context, in *TranslateTextReq, opts ...grpc.CallOption) (*TranslateTextResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslateTextResp)
	err := c.cc.Invoke(ctx, Third_TranslateText_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedThirdServer) SpeechToText(context.Context, *SpeechToTextReq) (*SpeechToTextResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SpeechToText not implemented")
}
func (UnimplementedThirdServer) TranslateText(context.Context, *TranslateTextReq) (*TranslateTextResp, error) {
...
func _Third_SpeechToText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SpeechToTextReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThirdServer).SpeechToText(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Third_SpeechToText_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThirdServer).SpeechToText(ctx, req.(*SpeechToTextReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Third_TranslateText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslateTextReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThirdServer).TranslateText(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Third_TranslateText_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThirdServer).TranslateText(ctx, req.(*TranslateTextReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Third_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Third_SpeechToText_Handler,
		},
		{
			MethodName: "TranslateText",
			Handler:    _Third_TranslateText_Handler,
		},
	},
