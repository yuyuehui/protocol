...
type SpeechToTextResp struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RecognizedText string                 `protobuf:"bytes,1,opt,name=recognizedText,proto3" json:"recognizedText,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type TranslateTextReq struct {
	...
	TargetLanguage string                 `protobuf:"bytes,2,opt,name=targetLanguage,proto3" json:"targetLanguage,omitempty"`
