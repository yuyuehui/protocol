...
type SubUserOnlineStatusElem struct {
	...
	PlatformDetails   map[int32]int32        `protobuf:"bytes,3,rep,name=platformDetails,proto3" json:"platformDetails" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // 新增：平台详细状态 map[platformID]status
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
