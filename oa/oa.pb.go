...
type GetDepartmentTreeResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Departments   []*DepartmentInfoLite  `protobuf:"bytes,1,rep,name=departments,proto3" json:"departments"` // 部门列表（简化版，只包含必要字段）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DepartmentInfoLite struct {
	...
	Members             []*MemberInfo          `protobuf:"bytes,8,rep,name=members,proto3" json:"members"`                                                      // 部门直属成员列表
	HasSubDepartments   bool                   `protobuf:"varint,9,opt,name=has_sub_departments,json=hasSubDepartments,proto3" json:"has_sub_departments"`      // 是否有子部门（用于懒加载判断）
	HasMembers          bool                   `protobuf:"varint,10,opt,name=has_members,json=hasMembers,proto3" json:"has_members"`                            // 是否有成员（用于懒加载判断）
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
