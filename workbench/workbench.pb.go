...
const (
	...
	NotifyStatus_NOTIFY_STATUS_FAILED      NotifyStatus = 5 // 发送失败
)
...
func (x *CategoryInfo) GetTenantID() string {
	if x != nil {
		return x.TenantID
	}
	return ""
...
func (x *CreateCategoryReq) GetTenantID() string {
	if x != nil {
		return x.TenantID
	}
	return ""
...
func (x *GetCategoryListReq) GetTenantID() string {
	if x != nil {
		return x.TenantID
	}
	return ""
...
const file_workbench_workbench_proto_rawDesc = "" +
	...
	" \x01(\x03R\n" +
	"reviewedAt\x12 \n" +
	"\vpublishedAt\x18\v \x01(\x03R\vpublishedAt\"\x9c\x02\n" +
	...
	"\bchildren\x18\b \x03(\v2\x1e.openim.workbench.CategoryInfoR\bchildren\x12\x1a\n" +
	"\btenantID\x18\t \x01(\tR\btenantID\"\xd8\x02\n" +
	"\n" +
	"BannerInfo\x12\x1a\n" +
	...
	"\tskipCount\x18\x02 \x01(\x03R\tskipCount\"\x91\x01\n" +
	"\x11CreateCategoryReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04icon\x18\x02 \x01(\tR\x04icon\x12\x1c\n" +
	"\tsortOrder\x18\x03 \x01(\x05R\tsortOrder\x12\x1a\n" +
	"\bparentID\x18\x04 \x01(\tR\bparentID\x12\x1a\n" +
	"\btenantID\x18\x05 \x01(\tR\btenantID\"4\n" +
	...
	"categoryID\x18\x01 \x01(\tR\n" +
	"categoryID\"\x14\n" +
	"\x12DeleteCategoryResp\"0\n" +
	"\x12GetCategoryListReq\x12\x1a\n" +
	"\btenantID\x18\x01 \x01(\tR\btenantID\"U\n" +
	...
	"\x16VISIBILITY_TYPE_CUSTOM\x10\x02*\xad\x01\n" +
	...
	"\x15NOTIFY_STATUS_REVOKED\x10\x04\x12\x18\n" +
	"\x14NOTIFY_STATUS_FAILED\x10\x05*b\n" +
